...
export const zhCN: Translations = {
  ...
  skills: {
    title: "技能",
    description: "管理和配置 DeerFlow 技能以扩展其能力。",
    createSkill: "创建技能",
    searchSkills: "搜索技能...",
    allSkills: "全部技能",
    publicSkills: "公共",
    customSkills: "自定义",
    emptyTitle: "还没有技能",
    emptyDescription: "创建你的第一个技能来扩展 DeerFlow 的能力。",
    editSkill: "编辑技能",
    deleteConfirm: "确定要删除此技能吗？此操作不可撤销。",
    deleteSuccess: "技能已删除",
    saveSuccess: "技能已保存",
    rollbackSuccess: "技能回滚成功",
    editor: "编辑器",
    history: "历史",
    rollback: "回滚",
    rollbackTo: "回滚到...",
    noHistory: "无可用历史记录",
    skillContentPlaceholder: "以 SKILL.md 格式输入技能内容...",
    author: "作者",
    skillName: "技能名称",
    ...
    skillContent: "技能内容",
    skillDetails: "技能详情",
    skillDetailsDesc: "使用 SKILL.md 格式定义你的技能",
    manualCreate: "手动创建",
    aiCreate: "AI 辅助",
    aiCreateTitle: "AI 辅助创建",
    aiCreateDesc: "让 AI 帮助你通过对话创建技能",
    aiCreateHint: "与 DeerFlow 对话",
    aiCreateHintDesc: "描述你希望技能做什么，DeerFlow 将帮助你创建它",
    startChat: "开始对话",
  ...
  hitl: {
    title: "人机协作",
    description: "管理需要你的人工介入的 HITL 请求。",
    pendingCount: "待处理",
    searchPending: "搜索待处理请求...",
    filterByType: "按类型筛选",
    allTypes: "所有类型",
    noPending: "没有待处理请求",
    noPendingDesc: "所有 HITL 请求都已处理。当智能体需要你的输入时，新请求将显示在这里。",
    loadError: "加载 HITL 请求失败",
    respond: "回复",
    respondToClarification: "回复澄清",
    responsePlaceholder: "输入你的回复...",
    customResponse: "自定义回复",
    responseSubmitted: "回复提交成功",
    threadId: "线程 ID",
    clarificationTypes: {
      missing_info: "缺少信息",
  ...
  observability: {
    ...
    noState: "暂无状态信息",
    healthStatus: "健康状态",
    healthDescription: "系统健康和状态信息",
    serviceStatus: "服务状态",
    serviceName: "服务名称",
    endpoints: "接口端点",
    endpointsDescription: "可用的 API 端点",
