...
export const enUS: Translations = {
  ...
  skills: {
    title: "Skills",
    description: "Manage and configure DeerFlow skills to extend its capabilities.",
    ...
    emptyDescription: "Create your first skill to extend DeerFlow's capabilities.",
    ...
    rollbackSuccess: "Skill rolled back successfully",
    editor: "Editor",
    history: "History",
    rollback: "Rollback",
    rollbackTo: "Rollback to...",
    noHistory: "No history available",
    skillContentPlaceholder: "Enter skill content in SKILL.md format...",
    author: "Author",
    ...
    skillDetailsDesc: "Define your skill using SKILL.md format",
    manualCreate: "Manual",
    aiCreate: "AI Assisted",
    aiCreateTitle: "Create with AI",
    aiCreateDesc: "Let AI help you create a skill through conversation",
    aiCreateHint: "Chat with DeerFlow",
    aiCreateHintDesc: "Describe what you want the skill to do, and DeerFlow will help you create it",
  ...
  hitl: {
    title: "HITL",
    description: "Manage Human-in-the-Loop requests that require your attention.",
    pendingCount: "Pending",
    searchPending: "Search pending requests...",
    filterByType: "Filter by type",
    allTypes: "All Types",
    noPending: "No pending requests",
    noPendingDesc: "All HITL requests have been handled. New requests will appear here when agents need your input.",
    loadError: "Failed to load HITL requests",
    respond: "Respond",
    respondToClarification: "Respond to Clarification",
  ...
  observability: {
    title: "Observability",
    description: "Monitor system health, thread states, and runtime metrics.",
    healthy: "Healthy",
    unhealthy: "Unhealthy",
    ...
    waitingForHITL: "Waiting for HITL",
    errors: "Errors",
    ...
    healthDescription: "System health and status information",
    serviceStatus: "Service Status",
    serviceName: "Service Name",
    endpoints: "Endpoints",
    endpointsDescription: "Available API endpoints",
